...
const ServicesSection = ({ setPage }) => {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full bg-[#050505] text-white flex flex-col z-10 overflow-hidden"
    >
      {/* Background Glow */}
      <div
        className="
      ...
      <section className="max-w-7xl mx-auto w-full px-6 pt-36 pb-20 md:px-12 md:pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-20 select-none">
          <div className="lg:col-span-8">
            <TextRevealCurtain
              as="h2"
              className="text-4xl md:text-6xl mb-4  font-extrabold font-korium tracking-wider leading-[0.9] text-white uppercase"
              lines={["AREA OF EXPERTISE"]}
            />
          </div>

          <div className="lg:col-span-4 flex flex-col items-start lg:items-end gap-6 pt-4 lg:pt-0">
            <p className="text-xs font-grotesk font-bold tracking-wider leading-relaxed text-white/85 max-w-sm lg:text-right">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <div className="card-face w-full h-full bg-[#6d28d9] border border-white/20">
                    ...
                    <div className="card-face card-back w-full h-full bg-white text-black p-6 flex flex-col justify-between select-none">
                      ...
                      <div className="flex justify-between items-start">
                        <span className="text-xs font-grotesk font-extrabold tracking-widest text-black/90">
                          {card.title}
                        </span>
                        <span className="w-6 h-6 bg-black text-white text-[11px] font-grotesk font-bold flex items-center justify-center">
                          {card.letter}
                        </span>
                      </div>

                      {/* Middle Services List */}
                      <div className="flex flex-col gap-3 py-6 my-auto text-left font-grotesk text-xs">
