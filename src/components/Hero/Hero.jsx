...
import ResumeENG from "/CV_Paula_Velez_WordPress Developer_Frontend (React)_(EN).pdf";
import ResumeESP from "/CV_Paula_Velez_WordPress Developer_Frontend (React)_(ES).pdf";
