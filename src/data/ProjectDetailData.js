...
const projectDetailData = [
  {
    ...
    year: "2025",
    client: "Agencia Lader — Real Billion",
    role: ["Frontend Developer", "Diseño UI"],
    stack: [
      "WordPress",
      "Elementor",
      "Elementor Pro",
  ...
  },
  {
    ...
    projectType: ["Commercial Landing"],
    year: "2025",
    client: "Agencia Lader — Atlantic Village",
    role: ["Frontend Developer", "Diseño UI"],
    stack: [
      "WordPress",
      "Elementor",
  ...
  },
  {
    ...
    year: "2025",
    client: "Agencia Lader — Maprim Sur",
  ...
  },
  {
    ...
    year: "2025",
    client: "Agencia Lader — Modena Autos",
    role: "Frontend Developer",
    stack: [
      "WordPress",
      "Elementor Pro",
  ...
  },
  {
    ...
    projectType: ["Corporate Website"],
    year: "2025",
    client: "Agencia Lader — Grupo Pensar",
    role: "Frontend Developer",
  ...
  },
  {
    ...
    projectType: ["Corporate Website"],
    year: "2025",
    client: "Agencia Lader — Red Apache Rent a Car",
    role: "Frontend Developer",
    stack: ["WordPress", "Elementor", "Elementor Pro"],
  ...
  },
  {
    ...
    year: "2025",
    client: "Agencia Lader — Valtoria Mármoles",
    role: "Frontend Developer",
    stack: ["WordPress", "Elementor", "Elementor Pro"],
    hero: ValtoriaMockup,
  ...
  },
  {
    ...
    projectType: ["Corporate Website"],
    year: "2025",
    client: "Agencia Lader — Pragma Abogados",
    role: "Frontend Developer",
    stack: [
      "WordPress",
      "Elementor",
  ...
  },
  {
    ...
    projectType: ["Corporate Website"],
    year: "2025",
    client: "Agencia Lader — Daser Agro",
    role: "Frontend Developer",
    stack: [
      "WordPress",
      "Elementor",
  ...
  },
  {
    ...
    year: "2025",
    client: "Agencia Lader — Instituto Impulso",
    role: "Frontend Developer",
    stack: [
      "WordPress",
      "WooCommerce",
  ...
  },
  {
    ...
    projectType: ["Landing Page"],
    year: "2025",
    client: "Agencia Lader — MD Inmobiliaria",
    role: "Frontend Developer",
    stack: [
      "WordPress",
      "Elementor",
  ...
  },
  {
    ...
    projectType: ["Landing Page"],
    year: "2025",
    client: "Agencia Lader — Groven Agency",
    role: "Frontend Developer",
    stack: [
      "WordPress",
      "Elementor",
      "Elementor Pro",
      "Rank Math SEO / Yoast SEO",
      "Site Kit de Google – Analytics, Search Console",
    ],
    hero: GrovenMockup,
    cover: GrovenMockup,
    AbsBG: ABS5,
  ...
  },
  {
    ...
    role: "Frontend Developer",
    stack: ["Tiendanube", "Andreani", "HTML5", "CSS3", "JavaScript"],
    hero: ILTMockup,
    cover: ILTMockup,
    AbsBG: ABS6,
  ...
  },
  {
    ...
    slug: "grupo-desinar",
    title: "Grupo Desinar",
    categories: ["Frontend Development", "Wix"],
    projectType: ["Corporate Website"],
    year: "2025",
    client: "Agencia Lader — Grupo Desinar",
    role: "Frontend Developer",
    stack: ["Wix", "Figma", "JavaScript", "HTML5", "CSS3"],
    hero: DesinarMockup,
    cover: DesinarMockup,
    AbsBG: ABS7,
  ...
  },
  {
    ...
    year: "2025",
    client: "Agencia Lader — Lyfe Resort & Residences",
    role: "Frontend Developer",
    stack: [
      "WordPress",
      "Elementor",
